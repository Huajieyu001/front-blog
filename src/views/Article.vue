<template>
    ...
    <div style="margin-top: 10px;">
        ...
        <el-input ref="inputTitle" v-model="articleStore.title" style="width: 60vw" :rows="2" type="textarea"
            placeholder="请输入标题" autosize maxlength="50" show-word-limit="true"
            input-style="font-size:large; font-weight:bold;" :autofocus="true" />
    </div>
    <div style="margin-top: 10px;">
        <div style="font-weight: bold;">概述</div>
        <el-input v-model="articleStore.summary" style="width: 60vw" :rows="2" type="textarea" placeholder="请输入概述"
            autosize maxlength="200" show-word-limit="true" />
    </div>
    <br></br>
    <br></br>
